		...
		<div className="flex flex-col h-full">
			...
			<div className="p-4 bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 mt-auto">
				<div className="relative">
					<input type="text" placeholder="Ask a question based on the vector storage..." className="w-full py-3 pl-4 pr-12 text-sm bg-gray-100 dark:bg-gray-700 border border-transparent rounded-full focus:outline-none focus:ring-2 focus:ring-indigo-500" />
					<button className="absolute inset-y-0 right-0 flex items-center justify-center w-12 text-indigo-500 hover:text-indigo-600">
